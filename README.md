...
These are opt-in shared-engine policies. Fiji’s physical geometry remains exactly equal to commit `1f971eb55e5d8ce79d35d28dcd70ecd351995ab3`, enforced by `tests/polowat-layout.test.ts`. Terminal adapters preserve face-normal exits and reject backward approach bends. All existing collision and rendering gates remain enabled.
